...
void Console_puts(char *caMessage)
{
	while(*caMessage!=0)
	{
		Console_putc(*caMessage++);
	}
}
...
//		else
//			serial_puts("SPL: Unsupported Boot Device!\n");
//#endif
...
void board_init_r(/*gd_t*/ ulong *dummy1, ulong dummy2)
{
//	u32 spl_boot_list[] = {
//		BOOT_DEVICE_NONE,
//		BOOT_DEVICE_NONE,
...
//		serial_puts("SPL: failed to boot from all boot devices\n");
//		hang();
//	}
//
//	switch (spl_image.os) {
...
//		serial_puts("Unsupported OS image.. Jumping nevertheless..\n");			 
//	}
...
//	
	...
	Console_puts("\n\r");
	Console_puts("                                       \\o.o/\n\r");
	Console_puts("---------------------------------.ooO---(_)---Ooo.----------\n\r");
	Console_puts("\n\r"); 
	Console_puts("    U-Boot SPL " PLAIN_VERSION " (" __DATE__ " - " __TIME__ ")\n\r");
			
	Console_puts("    Custom Version FDy\n\r");	
	Console_puts("\n\r"); 
	Console_puts("--------------------------------------------Oooo.-----------\n\r");
	Console_puts("                                     .oooO  (   )\n\r");
	Console_puts("                                     (   )   ) /\n\r");
